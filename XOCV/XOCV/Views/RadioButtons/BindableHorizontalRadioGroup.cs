...
{
    public class BindableHorizontalRadioGroup : StackLayout
    {
        public List<CustomRadioButton> rads;

        public BindableHorizontalRadioGroup()
        {
        ...
        public static BindableProperty ItemsSourceProperty =
            BindableProperty.Create<BindableHorizontalRadioGroup, IEnumerable>
            (o => o.ItemsSource, default(IEnumerable), propertyChanged: OnItemsSourceChanged);


        public static BindableProperty SelectedIndexProperty =
            BindableProperty.Create<BindableHorizontalRadioGroup, int>
        ...
        public static BindableProperty MultiSelectedIndexesProperty =
            BindableProperty.Create<BindableHorizontalRadioGroup, ObservableCollection<string>>
        ...
        {
            var radButtons = bindable as BindableHorizontalRadioGroup;
        ...
        private static void OnSelectedIndexChanged(BindableObject bindable, int oldvalue, int newvalue)
        {
            ...
            var bindableRadioGroup = bindable as BindableHorizontalRadioGroup;
