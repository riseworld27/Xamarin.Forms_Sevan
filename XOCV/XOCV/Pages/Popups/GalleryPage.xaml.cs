...
namespace XOCV.Pages.Popups
{
	public partial class GalleryPage : XOCVPage
	{
		...
		void RefreshCarousel()
		{
			carousel = null;
			pageIndicator = null;
			carousel = new CarouselLayout { HorizontalOptions = LayoutOptions.FillAndExpand, VerticalOptions = LayoutOptions.FillAndExpand };
			...
			pageIndicator.SetBinding(PagerIndicatorDots.ItemsSourceProperty, new Binding("CarouselPages", BindingMode.TwoWay));
			pageIndicator.SetBinding(PagerIndicatorDots.SelectedItemProperty, new Binding("CurrentPage", BindingMode.TwoWay));
		}
	}
}
